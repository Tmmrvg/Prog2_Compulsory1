...
%DXC% /auto-binding-space 0 /Zpr /O3 -Wno-parentheses-equality /T ps_6_6 /E MainPixelShader /Fc LightMapDensityShader.d3dasm /Fo LightMapDensityShader.dxil LightMapDensityShader.usf
:END
PAUSE
