...
%DXC% /auto-binding-space 0 /Zpr /O3 -Wno-parentheses-equality /T vs_6_6 /E MainVertexShader /Fc LightMapDensityShader.d3dasm /Fo LightMapDensityShader.dxil LightMapDensityShader.usf
:END
PAUSE
