...
%DXC% /auto-binding-space 0 /Zpr /O3 -Wno-parentheses-equality /T ps_6_6 /E Main /Fc ShadowDepthPixelShader.d3dasm /Fo ShadowDepthPixelShader.dxil ShadowDepthPixelShader.usf
:END
PAUSE
