...
%DXC% -HV 2021 /auto-binding-space 0 /Zpr /O3 -Wno-parentheses-equality /T ps_6_6 /E Merge /Fc DistortApplyScreenPS.d3dasm /Fo DistortApplyScreenPS.dxil DistortApplyScreenPS.usf
:END
PAUSE
