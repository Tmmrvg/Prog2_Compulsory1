...
%DXC% -HV 2021 /auto-binding-space 0 /Zpr /O3 -Wno-parentheses-equality /T cs_6_6 /E MainCS /Fc BloomFindKernelCenter.d3dasm /Fo BloomFindKernelCenter.dxil BloomFindKernelCenter.usf
:END
PAUSE
