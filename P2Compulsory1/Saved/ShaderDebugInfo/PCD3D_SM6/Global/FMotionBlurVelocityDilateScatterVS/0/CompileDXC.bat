...
%DXC% -HV 2021 /auto-binding-space 0 /Zpr /O3 -Wno-parentheses-equality /T vs_6_6 /E MainVS /Fc MotionBlurTileScatter.d3dasm /Fo MotionBlurTileScatter.dxil MotionBlurTileScatter.usf
:END
PAUSE
