...
%DXC% -HV 2021 /auto-binding-space 0 /Zpr /O3 -Wno-parentheses-equality /T cs_6_6 /E BuildBokehLUTMainCS /Fc DOFBokehLUT.d3dasm /Fo DOFBokehLUT.dxil DOFBokehLUT.usf
:END
PAUSE
