...
%DXC% -HV 2021 /auto-binding-space 0 /Zpr /O3 -Wno-parentheses-equality /T vs_6_6 /E RasterizeToRectsVS /Fc RenderGraphUtilities.d3dasm /Fo RenderGraphUtilities.dxil RenderGraphUtilities.usf
:END
PAUSE
