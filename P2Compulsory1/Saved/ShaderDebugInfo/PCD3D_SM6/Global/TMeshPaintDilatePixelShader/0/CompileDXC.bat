...
%DXC% -HV 2021 /auto-binding-space 0 /Zpr /O3 -Wno-parentheses-equality /T ps_6_6 /E Main /Fc meshpaintdilatepixelshader.d3dasm /Fo meshpaintdilatepixelshader.dxil meshpaintdilatepixelshader.usf
:END
PAUSE
