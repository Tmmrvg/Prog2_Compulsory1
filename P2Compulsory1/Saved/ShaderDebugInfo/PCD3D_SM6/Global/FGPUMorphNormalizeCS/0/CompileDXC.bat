...
%DXC% -HV 2021 /auto-binding-space 0 /Zpr /O3 -Wno-parentheses-equality /T cs_6_6 /E GPUMorphNormalizeCS /Fc MorphTargets.d3dasm /Fo MorphTargets.dxil MorphTargets.usf
:END
PAUSE
