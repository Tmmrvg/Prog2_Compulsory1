...
%DXC% -HV 2021 /auto-binding-space 0 /Zpr /O3 -Wno-parentheses-equality /T vs_6_6 /E VertexMain /Fc ParticleSimulationShader.d3dasm /Fo ParticleSimulationShader.dxil ParticleSimulationShader.usf
:END
PAUSE
