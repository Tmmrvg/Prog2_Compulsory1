...
%DXC% -HV 2021 /auto-binding-space 0 /Zpr /O3 -Wno-parentheses-equality /T vs_6_6 /E Main /Fc MeshPaintVertexShader.d3dasm /Fo MeshPaintVertexShader.dxil MeshPaintVertexShader.usf
:END
PAUSE
