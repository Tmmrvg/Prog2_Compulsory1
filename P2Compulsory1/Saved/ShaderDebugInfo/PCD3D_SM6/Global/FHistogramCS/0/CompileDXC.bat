...
%DXC% -HV 2021 /auto-binding-space 0 /Zpr /O1 -Wno-parentheses-equality /T cs_6_6 /E MainCS /Fc PostProcessHistogram.d3dasm /Fo PostProcessHistogram.dxil PostProcessHistogram.usf
:END
PAUSE
