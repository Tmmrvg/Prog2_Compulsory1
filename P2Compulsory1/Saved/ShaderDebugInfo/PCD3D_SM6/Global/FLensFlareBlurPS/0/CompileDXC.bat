...
%DXC% -HV 2021 /auto-binding-space 0 /Zpr /O3 -Wno-parentheses-equality /T ps_6_6 /E LensFlareBlurPS /Fc PostProcessLensFlares.d3dasm /Fo PostProcessLensFlares.dxil PostProcessLensFlares.usf
:END
PAUSE
