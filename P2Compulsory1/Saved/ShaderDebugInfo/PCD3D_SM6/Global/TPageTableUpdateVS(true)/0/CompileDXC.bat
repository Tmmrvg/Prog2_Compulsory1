...
%DXC% -HV 2021 /auto-binding-space 0 /Zpr /O3 -Wno-parentheses-equality /T vs_6_6 /E PageTableUpdateVS /Fc PageTableUpdate.d3dasm /Fo PageTableUpdate.dxil PageTableUpdate.usf
:END
PAUSE
