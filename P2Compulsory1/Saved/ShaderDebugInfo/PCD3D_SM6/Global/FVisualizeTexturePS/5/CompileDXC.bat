...
%DXC% -HV 2021 /auto-binding-space 0 /Zpr /O3 -Wno-parentheses-equality /T ps_6_6 /E VisualizeTexturePS /Fc VisualizeTexture.d3dasm /Fo VisualizeTexture.dxil VisualizeTexture.usf
:END
PAUSE
