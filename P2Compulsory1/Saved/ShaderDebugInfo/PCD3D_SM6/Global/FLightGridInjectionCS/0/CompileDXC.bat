...
%DXC% -HV 2021 /auto-binding-space 0 /Zpr /O3 -Wno-parentheses-equality /T cs_6_6 /E LightGridInjectionCS /Fc LightGridInjection.d3dasm /Fo LightGridInjection.dxil LightGridInjection.usf
:END
PAUSE
