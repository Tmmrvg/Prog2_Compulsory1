...
%DXC% -HV 2021 /auto-binding-space 0 /Zpr /O3 -Wno-parentheses-equality /T ps_6_6 /E MainDepth /Fc ResolvePixelShader.d3dasm /Fo ResolvePixelShader.dxil ResolvePixelShader.usf
:END
PAUSE
