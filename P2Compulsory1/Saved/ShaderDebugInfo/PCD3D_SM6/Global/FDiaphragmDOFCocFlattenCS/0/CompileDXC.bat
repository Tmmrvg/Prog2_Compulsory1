...
%DXC% -HV 2021 /auto-binding-space 0 /Zpr /O3 -Wno-parentheses-equality /T cs_6_6 /E CocFlattenMainCS /Fc DOFCocTileFlatten.d3dasm /Fo DOFCocTileFlatten.dxil DOFCocTileFlatten.usf
:END
PAUSE
