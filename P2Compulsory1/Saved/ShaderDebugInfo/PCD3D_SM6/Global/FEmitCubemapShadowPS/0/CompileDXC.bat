...
%DXC% -HV 2021 /auto-binding-space 0 /Zpr /O3 -Wno-parentheses-equality /T ps_6_6 /E EmitCubemapShadowPS /Fc NaniteEmitShadow.d3dasm /Fo NaniteEmitShadow.dxil NaniteEmitShadow.usf
:END
PAUSE
