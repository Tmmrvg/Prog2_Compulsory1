...
%DXC% -HV 2021 /auto-binding-space 0 /Zpr /O1 -Wno-parentheses-equality /T cs_6_6 /E RadixSort_Spine /Fc RadixSortShaders.d3dasm /Fo RadixSortShaders.dxil RadixSortShaders.usf
:END
PAUSE
