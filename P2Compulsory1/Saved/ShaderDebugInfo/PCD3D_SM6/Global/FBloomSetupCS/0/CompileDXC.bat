...
%DXC% -HV 2021 /auto-binding-space 0 /Zpr /O3 -Wno-parentheses-equality /T cs_6_6 /E BloomSetupCS /Fc PostProcessBloom.d3dasm /Fo PostProcessBloom.dxil PostProcessBloom.usf
:END
PAUSE
