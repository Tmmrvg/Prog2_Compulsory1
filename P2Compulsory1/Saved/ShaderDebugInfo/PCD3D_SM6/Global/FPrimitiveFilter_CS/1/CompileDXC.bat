...
%DXC% -HV 2021 /auto-binding-space 0 /Zpr /O3 -Wno-parentheses-equality /T cs_6_6 /E PrimitiveFilter /Fc NanitePrimitiveFilter.d3dasm /Fo NanitePrimitiveFilter.dxil NanitePrimitiveFilter.usf
:END
PAUSE
