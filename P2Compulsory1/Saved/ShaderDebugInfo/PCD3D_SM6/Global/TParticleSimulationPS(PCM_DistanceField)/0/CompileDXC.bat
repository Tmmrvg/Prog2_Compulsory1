...
%DXC% -HV 2021 /auto-binding-space 0 /Zpr /O3 -Wno-parentheses-equality /T ps_6_6 /E PixelMain /Fc ParticleSimulationShader.d3dasm /Fo ParticleSimulationShader.dxil ParticleSimulationShader.usf
:END
PAUSE
