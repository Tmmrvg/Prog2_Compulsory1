...
%DXC% -HV 2021 /auto-binding-space 0 /Zpr /O3 -Wno-parentheses-equality /T vs_6_6 /E Main /Fc SimpleElementVertexShader.d3dasm /Fo SimpleElementVertexShader.dxil SimpleElementVertexShader.usf
:END
PAUSE
