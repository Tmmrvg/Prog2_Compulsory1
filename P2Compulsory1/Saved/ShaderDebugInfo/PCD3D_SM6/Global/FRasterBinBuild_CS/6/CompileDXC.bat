...
%DXC% -HV 2021 /auto-binding-space 0 /Zpr /O3 -Wno-parentheses-equality /T cs_6_6 /E RasterBinBuild /Fc NaniteRasterBinning.d3dasm /Fo NaniteRasterBinning.dxil NaniteRasterBinning.usf
:END
PAUSE
