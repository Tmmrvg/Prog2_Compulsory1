...
%DXC% -HV 2021 /auto-binding-space 0 /Zpr /O3 -Wno-parentheses-equality /T ps_6_6 /E FinishOcclusionMain /Fc LightShaftShader.d3dasm /Fo LightShaftShader.dxil LightShaftShader.usf
:END
PAUSE
