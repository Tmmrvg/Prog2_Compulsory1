...
%DXC% -HV 2021 /auto-binding-space 0 /Zpr /O3 -Wno-parentheses-equality /T cs_6_6 /E NodeAndClusterCull /Fc NaniteClusterCulling.d3dasm /Fo NaniteClusterCulling.dxil NaniteClusterCulling.usf
:END
PAUSE
