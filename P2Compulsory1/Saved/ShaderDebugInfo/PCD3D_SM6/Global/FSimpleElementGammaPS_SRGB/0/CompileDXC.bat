...
%DXC% -HV 2021 /auto-binding-space 0 /Zpr /O3 -Wno-parentheses-equality /T ps_6_6 /E GammaMain /Fc SimpleElementPixelShader.d3dasm /Fo SimpleElementPixelShader.dxil SimpleElementPixelShader.usf
:END
PAUSE
