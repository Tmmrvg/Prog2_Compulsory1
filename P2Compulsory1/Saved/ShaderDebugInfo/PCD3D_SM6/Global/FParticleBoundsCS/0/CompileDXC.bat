...
%DXC% -HV 2021 /auto-binding-space 0 /Zpr /O1 -Wno-parentheses-equality /T cs_6_6 /E ComputeParticleBounds /Fc ParticleBoundsShader.d3dasm /Fo ParticleBoundsShader.dxil ParticleBoundsShader.usf
:END
PAUSE
