...
%DXC% -HV 2021 /auto-binding-space 0 /Zpr /WX /O3 -Wno-parentheses-equality /T cs_6_6 /E MainCS /Fc TSRResolveHistory.d3dasm /Fo TSRResolveHistory.dxil TSRResolveHistory.usf
:END
PAUSE
