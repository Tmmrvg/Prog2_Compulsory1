...
%DXC% -HV 2021 /auto-binding-space 0 /Zpr /O3 -Wno-parentheses-equality /T ps_6_6 /E MainPS /Fc MotionBlurTileScatter.d3dasm /Fo MotionBlurTileScatter.dxil MotionBlurTileScatter.usf
:END
PAUSE
