...
%DXC% -HV 2021 /auto-binding-space 0 /Zpr /O3 -Wno-parentheses-equality /T vs_6_6 /E EmitCubemapShadowVS /Fc NaniteEmitShadow.d3dasm /Fo NaniteEmitShadow.dxil NaniteEmitShadow.usf
:END
PAUSE
