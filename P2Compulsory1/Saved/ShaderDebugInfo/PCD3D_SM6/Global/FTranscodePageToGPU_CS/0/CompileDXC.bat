...
%DXC% -HV 2021 /auto-binding-space 0 /Zpr /O3 -Wno-parentheses-equality /T cs_6_6 /E TranscodePageToGPU /Fc NaniteTranscode.d3dasm /Fo NaniteTranscode.dxil NaniteTranscode.usf
:END
PAUSE
