...
%DXC% -HV 2021 /auto-binding-space 0 /Zpr /WX /O3 -Wno-parentheses-equality /T cs_6_6 /E MainCS /Fc TSRFilterAntiAliasing.d3dasm /Fo TSRFilterAntiAliasing.dxil TSRFilterAntiAliasing.usf
:END
PAUSE
