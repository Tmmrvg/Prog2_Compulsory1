...
%DXC% -HV 2021 /auto-binding-space 0 /Zpr /O3 -Wno-parentheses-equality /T vs_6_6 /E MainVS /Fc PostProcessSubsurfaceTile.d3dasm /Fo PostProcessSubsurfaceTile.dxil PostProcessSubsurfaceTile.usf
:END
PAUSE
