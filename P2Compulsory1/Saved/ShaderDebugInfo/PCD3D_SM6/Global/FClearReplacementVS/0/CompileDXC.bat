...
%DXC% -HV 2021 /auto-binding-space 0 /Zpr /O3 -Wno-parentheses-equality /T vs_6_6 /E ClearVS /Fc ClearReplacementShaders.d3dasm /Fo ClearReplacementShaders.dxil ClearReplacementShaders.usf
:END
PAUSE
