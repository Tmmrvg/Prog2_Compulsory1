...
%DXC% -HV 2021 /auto-binding-space 0 /Zpr /Od -Wno-parentheses-equality /T cs_6_6 /E GPUSceneDebugRenderCS /Fc GPUSceneDebugRender.d3dasm /Fo GPUSceneDebugRender.dxil GPUSceneDebugRender.usf
:END
PAUSE
