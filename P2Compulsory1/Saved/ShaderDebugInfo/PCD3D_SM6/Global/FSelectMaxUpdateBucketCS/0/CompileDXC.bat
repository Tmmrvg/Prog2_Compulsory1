...
%DXC% -HV 2021 /auto-binding-space 0 /Zpr /O3 -Wno-parentheses-equality /T cs_6_6 /E SelectMaxUpdateBucketCS /Fc LumenSceneLighting.d3dasm /Fo LumenSceneLighting.dxil LumenSceneLighting.usf
:END
PAUSE
