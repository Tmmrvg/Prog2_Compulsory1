...
%DXC% -HV 2021 /auto-binding-space 0 /Zpr /O3 -Wno-parentheses-equality /T cs_6_6 /E MainCS /Fc MotionBlurVelocityFlatten.d3dasm /Fo MotionBlurVelocityFlatten.dxil MotionBlurVelocityFlatten.usf
:END
PAUSE
