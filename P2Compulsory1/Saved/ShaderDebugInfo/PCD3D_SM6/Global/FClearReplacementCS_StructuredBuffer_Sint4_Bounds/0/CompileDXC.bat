...
%DXC% -HV 2021 /auto-binding-space 0 /Zpr /O3 -Wno-parentheses-equality /T cs_6_6 /E ClearCS /Fc ClearReplacementShaders.d3dasm /Fo ClearReplacementShaders.dxil ClearReplacementShaders.usf
:END
PAUSE
