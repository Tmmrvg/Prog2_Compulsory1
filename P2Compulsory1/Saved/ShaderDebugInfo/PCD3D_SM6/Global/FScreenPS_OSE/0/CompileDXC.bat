...
%DXC% -HV 2021 /auto-binding-space 0 /Zpr /O3 -Wno-parentheses-equality /T ps_6_6 /E Main /Fc ScreenPixelShaderOES.d3dasm /Fo ScreenPixelShaderOES.dxil ScreenPixelShaderOES.usf
:END
PAUSE
