...
%DXC% -HV 2021 /auto-binding-space 0 /Zpr /O3 -Wno-parentheses-equality /T ps_6_6 /E Main /Fc SimpleTexture2DPS.d3dasm /Fo SimpleTexture2DPS.dxil SimpleTexture2DPS.usf
:END
PAUSE
