...
%DXC% -HV 2021 /auto-binding-space 0 /Zpr /O3 -Wno-parentheses-equality /T cs_6_6 /E ClearCompressedAtlasCS /Fc LumenSurfaceCache.d3dasm /Fo LumenSurfaceCache.dxil LumenSurfaceCache.usf
:END
PAUSE
