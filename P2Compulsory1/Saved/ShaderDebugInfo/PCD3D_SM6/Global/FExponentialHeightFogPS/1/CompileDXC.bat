...
%DXC% -HV 2021 /auto-binding-space 0 /Zpr /O3 -Wno-parentheses-equality /T ps_6_6 /E ExponentialPixelMain /Fc HeightFogPixelShader.d3dasm /Fo HeightFogPixelShader.dxil HeightFogPixelShader.usf
:END
PAUSE
