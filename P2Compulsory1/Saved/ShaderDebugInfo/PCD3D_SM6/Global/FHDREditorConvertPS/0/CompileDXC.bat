...
%DXC% -HV 2021 /auto-binding-space 0 /Zpr /O3 -Wno-parentheses-equality /T ps_6_6 /E HDREditorConvert /Fc CompositeUIPixelShader.d3dasm /Fo CompositeUIPixelShader.dxil CompositeUIPixelShader.usf
:END
PAUSE
