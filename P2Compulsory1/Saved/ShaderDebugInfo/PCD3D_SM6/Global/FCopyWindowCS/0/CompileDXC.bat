...
%DXC% -HV 2021 /auto-binding-space 0 /Zpr /O3 -Wno-parentheses-equality /T cs_6_6 /E CopyWindowCS /Fc GPUFastFourierTransform.d3dasm /Fo GPUFastFourierTransform.dxil GPUFastFourierTransform.usf
:END
PAUSE
