...
%DXC% -HV 2021 /auto-binding-space 0 /Zpr /O3 -Wno-parentheses-equality /T cs_6_6 /E ComputeFreeIDs /Fc NiagaraComputeFreeIDs.d3dasm /Fo NiagaraComputeFreeIDs.dxil NiagaraComputeFreeIDs.usf
:END
PAUSE
