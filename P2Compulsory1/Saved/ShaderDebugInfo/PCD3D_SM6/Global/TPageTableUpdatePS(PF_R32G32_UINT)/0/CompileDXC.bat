...
%DXC% -HV 2021 /auto-binding-space 0 /Zpr /O3 -Wno-parentheses-equality /T ps_6_6 /E PageTableUpdatePS_2 /Fc PageTableUpdate.d3dasm /Fo PageTableUpdate.dxil PageTableUpdate.usf
:END
PAUSE
