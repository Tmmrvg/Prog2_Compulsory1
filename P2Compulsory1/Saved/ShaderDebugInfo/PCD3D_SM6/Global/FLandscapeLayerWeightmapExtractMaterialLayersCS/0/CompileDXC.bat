...
%DXC% -HV 2021 /auto-binding-space 0 /Zpr /O3 -Wno-parentheses-equality /T cs_6_6 /E ComputeWeightmapPerPaintLayer /Fc LandscapeLayersCS.d3dasm /Fo LandscapeLayersCS.dxil LandscapeLayersCS.usf
:END
PAUSE
