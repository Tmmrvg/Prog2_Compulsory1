...
%DXC% -HV 2021 /auto-binding-space 0 /Zpr /O3 -Wno-parentheses-equality /T cs_6_6 /E LumenRadiosityDistanceFieldTracingCS /Fc LumenRadiosity.d3dasm /Fo LumenRadiosity.dxil LumenRadiosity.usf
:END
PAUSE
