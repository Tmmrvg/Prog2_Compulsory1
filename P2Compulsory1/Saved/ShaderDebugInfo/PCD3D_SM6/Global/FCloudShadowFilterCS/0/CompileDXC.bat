...
%DXC% -HV 2021 /auto-binding-space 0 /Zpr /O3 -Wno-parentheses-equality /T cs_6_6 /E MainShadowFilterCS /Fc VolumetricCloud.d3dasm /Fo VolumetricCloud.dxil VolumetricCloud.usf
:END
PAUSE
