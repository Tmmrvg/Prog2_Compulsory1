...
%DXC% -HV 2021 /auto-binding-space 0 /Zpr /O3 -Wno-parentheses-equality /T vs_6_6 /E LensFlareBlurVS /Fc PostProcessLensFlares.d3dasm /Fo PostProcessLensFlares.dxil PostProcessLensFlares.usf
:END
PAUSE
