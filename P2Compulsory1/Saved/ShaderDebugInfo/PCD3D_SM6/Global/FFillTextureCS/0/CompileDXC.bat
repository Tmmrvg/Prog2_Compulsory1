...
%DXC% -HV 2021 /auto-binding-space 0 /Zpr /O3 -Wno-parentheses-equality /T cs_6_6 /E MainFillTextureCS /Fc OneColorShader.d3dasm /Fo OneColorShader.dxil OneColorShader.usf
:END
PAUSE
