...
%DXC% -HV 2021 /auto-binding-space 0 /Zpr /O3 -Wno-parentheses-equality /T ps_6_6 /E MainForCubemap /Fc OculusShaders.d3dasm /Fo OculusShaders.dxil OculusShaders.usf
:END
PAUSE
