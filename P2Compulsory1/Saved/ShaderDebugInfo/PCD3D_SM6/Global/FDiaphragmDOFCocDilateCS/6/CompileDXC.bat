...
%DXC% -HV 2021 /auto-binding-space 0 /Zpr /O3 -Wno-parentheses-equality /T cs_6_6 /E CocDilateMainCS /Fc DOFCocTileDilate.d3dasm /Fo DOFCocTileDilate.dxil DOFCocTileDilate.usf
:END
PAUSE
