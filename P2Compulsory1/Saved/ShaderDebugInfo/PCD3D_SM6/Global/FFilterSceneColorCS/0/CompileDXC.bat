...
%DXC% -HV 2021 /auto-binding-space 0 /Zpr /O3 -Wno-parentheses-equality /T cs_6_6 /E FilterColorCS /Fc DistortFiltering.d3dasm /Fo DistortFiltering.dxil DistortFiltering.usf
:END
PAUSE
