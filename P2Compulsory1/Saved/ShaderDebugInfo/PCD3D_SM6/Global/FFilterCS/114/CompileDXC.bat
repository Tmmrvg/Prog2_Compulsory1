...
%DXC% -HV 2021 /auto-binding-space 0 /Zpr /O3 -Wno-parentheses-equality /T cs_6_6 /E MainCS /Fc FilterPixelShader.d3dasm /Fo FilterPixelShader.dxil FilterPixelShader.usf
:END
PAUSE
