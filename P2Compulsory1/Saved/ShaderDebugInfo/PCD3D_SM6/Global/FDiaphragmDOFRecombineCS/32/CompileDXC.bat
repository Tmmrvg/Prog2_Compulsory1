...
%DXC% -HV 2021 /auto-binding-space 0 /Zpr /O3 -Wno-parentheses-equality /T cs_6_6 /E RecombineMainCS /Fc DOFRecombine.d3dasm /Fo DOFRecombine.dxil DOFRecombine.usf
:END
PAUSE
