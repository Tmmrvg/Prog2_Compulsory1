...
%DXC% -HV 2021 /auto-binding-space 0 /Zpr /O3 -Wno-parentheses-equality /T cs_6_6 /E MainCS /Fc FilmGrainPackConstants.d3dasm /Fo FilmGrainPackConstants.dxil FilmGrainPackConstants.usf
:END
PAUSE
