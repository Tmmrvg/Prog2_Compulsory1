...
%DXC% -HV 2021 /auto-binding-space 0 /Zpr /O3 -Wno-parentheses-equality /T ps_6_6 /E Main /Fc MeshPaintPixelShader.d3dasm /Fo MeshPaintPixelShader.dxil MeshPaintPixelShader.usf
:END
PAUSE
