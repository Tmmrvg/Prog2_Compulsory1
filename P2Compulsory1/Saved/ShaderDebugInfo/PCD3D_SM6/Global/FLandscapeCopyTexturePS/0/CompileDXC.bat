...
%DXC% -HV 2021 /auto-binding-space 0 /Zpr /O3 -Wno-parentheses-equality /T ps_6_6 /E CopyTexturePS /Fc LandscapeLayersPS.d3dasm /Fo LandscapeLayersPS.dxil LandscapeLayersPS.usf
:END
PAUSE
