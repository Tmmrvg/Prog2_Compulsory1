...
%DXC% -HV 2021 /auto-binding-space 0 /Zpr /WX /O3 -Wno-parentheses-equality /T cs_6_6 /E MainCS /Fc TSRUpdateHistory.d3dasm /Fo TSRUpdateHistory.dxil TSRUpdateHistory.usf
:END
PAUSE
