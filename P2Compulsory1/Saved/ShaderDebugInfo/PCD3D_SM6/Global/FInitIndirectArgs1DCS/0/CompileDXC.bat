...
%DXC% -HV 2021 /auto-binding-space 0 /Zpr /O3 -Wno-parentheses-equality /T cs_6_6 /E InitIndirectArgs1DCS /Fc SetupIndirectArgs.d3dasm /Fo SetupIndirectArgs.dxil SetupIndirectArgs.usf
:END
PAUSE
