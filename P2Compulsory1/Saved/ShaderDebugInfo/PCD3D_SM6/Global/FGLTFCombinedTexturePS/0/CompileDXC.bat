...
%DXC% -HV 2021 /auto-binding-space 0 /Zpr /O3 -Wno-parentheses-equality /T ps_6_6 /E Main /Fc CombinedTexturePS.d3dasm /Fo CombinedTexturePS.dxil CombinedTexturePS.usf
:END
PAUSE
