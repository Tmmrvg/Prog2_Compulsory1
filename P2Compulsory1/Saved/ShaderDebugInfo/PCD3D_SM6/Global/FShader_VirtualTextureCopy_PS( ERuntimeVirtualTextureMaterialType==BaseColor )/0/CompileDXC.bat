...
%DXC% -HV 2021 /auto-binding-space 0 /Zpr /O3 -Wno-parentheses-equality /T ps_6_6 /E CopyBaseColorPS /Fc VirtualTextureCompress.d3dasm /Fo VirtualTextureCompress.dxil VirtualTextureCompress.usf
:END
PAUSE
