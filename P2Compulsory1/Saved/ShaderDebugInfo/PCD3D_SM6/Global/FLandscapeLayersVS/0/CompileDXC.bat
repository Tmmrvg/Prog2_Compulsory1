...
%DXC% -HV 2021 /auto-binding-space 0 /Zpr /O3 -Wno-parentheses-equality /T vs_6_6 /E VSMain /Fc LandscapeLayersVS.d3dasm /Fo LandscapeLayersVS.dxil LandscapeLayersVS.usf
:END
PAUSE
