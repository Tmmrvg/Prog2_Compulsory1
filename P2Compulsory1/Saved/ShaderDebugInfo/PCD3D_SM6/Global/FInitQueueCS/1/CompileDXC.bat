...
%DXC% -HV 2021 /auto-binding-space 0 /Zpr /O3 -Wno-parentheses-equality /T cs_6_6 /E InitQueue /Fc NaniteStreamOut.d3dasm /Fo NaniteStreamOut.dxil NaniteStreamOut.usf
:END
PAUSE
