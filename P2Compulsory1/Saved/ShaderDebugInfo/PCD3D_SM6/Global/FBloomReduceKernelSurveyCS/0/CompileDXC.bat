...
%DXC% -HV 2021 /auto-binding-space 0 /Zpr /O3 -Wno-parentheses-equality /T cs_6_6 /E MainCS /Fc BloomReduceKernelSurvey.d3dasm /Fo BloomReduceKernelSurvey.dxil BloomReduceKernelSurvey.usf
:END
PAUSE
