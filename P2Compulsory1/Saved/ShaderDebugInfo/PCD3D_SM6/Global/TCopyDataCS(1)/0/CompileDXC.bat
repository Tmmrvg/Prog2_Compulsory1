...
%DXC% -HV 2021 /auto-binding-space 0 /Zpr /O3 -Wno-parentheses-equality /T cs_6_6 /E CopyData1CS /Fc UpdateTextureShaders.d3dasm /Fo UpdateTextureShaders.dxil UpdateTextureShaders.usf
:END
PAUSE
