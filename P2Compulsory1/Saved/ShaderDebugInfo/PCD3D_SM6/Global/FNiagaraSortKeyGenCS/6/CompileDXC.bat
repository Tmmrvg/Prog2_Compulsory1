...
%DXC% -HV 2021 /auto-binding-space 0 /Zpr /O3 -Wno-parentheses-equality /T cs_6_6 /E GenerateParticleSortKeys /Fc NiagaraSortKeyGen.d3dasm /Fo NiagaraSortKeyGen.dxil NiagaraSortKeyGen.usf
:END
PAUSE
