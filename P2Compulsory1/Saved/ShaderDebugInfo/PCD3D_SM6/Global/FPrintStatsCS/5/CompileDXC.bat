...
%DXC% -HV 2021 /auto-binding-space 0 /Zpr /O3 -Wno-parentheses-equality /T cs_6_6 /E PrintStats /Fc NanitePrintStats.d3dasm /Fo NanitePrintStats.dxil NanitePrintStats.usf
:END
PAUSE
