...
%DXC% -HV 2021 /auto-binding-space 0 /Zpr /O3 -Wno-parentheses-equality /T ps_6_6 /E ClearPS /Fc ClearReplacementShaders.d3dasm /Fo ClearReplacementShaders.dxil ClearReplacementShaders.usf
:END
PAUSE
