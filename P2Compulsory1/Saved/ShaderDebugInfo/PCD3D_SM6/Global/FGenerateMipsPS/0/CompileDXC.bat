...
%DXC% -HV 2021 /auto-binding-space 0 /Zpr /O3 -Wno-parentheses-equality /T ps_6_6 /E MainPS /Fc ComputeGenerateMips.d3dasm /Fo ComputeGenerateMips.dxil ComputeGenerateMips.usf
:END
PAUSE
