...
%DXC% -HV 2021 /auto-binding-space 0 /Zpr /O3 -Wno-parentheses-equality /T cs_6_6 /E GenerateParticleSortKeys /Fc ParticleSortKeyGen.d3dasm /Fo ParticleSortKeyGen.dxil ParticleSortKeyGen.usf
:END
PAUSE
