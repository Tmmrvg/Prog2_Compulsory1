...
%DXC% -HV 2021 /auto-binding-space 0 /Zpr /O3 -Wno-parentheses-equality /T cs_6_6 /E CompactStateBufferCS /Fc ShaderPrintDraw.d3dasm /Fo ShaderPrintDraw.dxil ShaderPrintDraw.usf
:END
PAUSE
