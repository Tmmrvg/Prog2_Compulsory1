...
%DXC% -HV 2021 /auto-binding-space 0 /Zpr /O3 -Wno-parentheses-equality /T ps_6_6 /E RenderSkyAtmosphereEditorHudPS /Fc SkyAtmosphere.d3dasm /Fo SkyAtmosphere.dxil SkyAtmosphere.usf
:END
PAUSE
