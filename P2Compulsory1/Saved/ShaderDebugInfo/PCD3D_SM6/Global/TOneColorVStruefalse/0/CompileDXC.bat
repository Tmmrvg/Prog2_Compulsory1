...
%DXC% -HV 2021 /auto-binding-space 0 /Zpr /O3 -Wno-parentheses-equality /T vs_6_6 /E MainVertexShader /Fc OneColorShader.d3dasm /Fo OneColorShader.dxil OneColorShader.usf
:END
PAUSE
