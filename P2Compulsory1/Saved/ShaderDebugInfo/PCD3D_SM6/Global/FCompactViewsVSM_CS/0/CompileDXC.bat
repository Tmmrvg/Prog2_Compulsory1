...
%DXC% -HV 2021 /auto-binding-space 0 /Zpr /O3 -Wno-parentheses-equality /T cs_6_6 /E CompactViewsVSM_CS /Fc NaniteInstanceCulling.d3dasm /Fo NaniteInstanceCulling.dxil NaniteInstanceCulling.usf
:END
PAUSE
