...
%DXC% -HV 2021 /auto-binding-space 0 /Zpr /O3 -Wno-parentheses-equality /T ps_6_6 /E Scrolling2DDepthPS /Fc CopyShadowMaps.d3dasm /Fo CopyShadowMaps.dxil CopyShadowMaps.usf
:END
PAUSE
