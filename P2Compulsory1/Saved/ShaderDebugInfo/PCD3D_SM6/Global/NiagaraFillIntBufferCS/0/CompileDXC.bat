...
%DXC% -HV 2021 /auto-binding-space 0 /Zpr /O3 -Wno-parentheses-equality /T cs_6_6 /E FillIntBuffer /Fc NiagaraFillIntBuffer.d3dasm /Fo NiagaraFillIntBuffer.dxil NiagaraFillIntBuffer.usf
:END
PAUSE
