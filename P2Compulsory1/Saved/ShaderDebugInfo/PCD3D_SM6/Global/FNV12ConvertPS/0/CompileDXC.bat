...
%DXC% -HV 2021 /auto-binding-space 0 /Zpr /O3 -Wno-parentheses-equality /T ps_6_6 /E NV12ConvertPS /Fc MediaShaders.d3dasm /Fo MediaShaders.dxil MediaShaders.usf
:END
PAUSE
