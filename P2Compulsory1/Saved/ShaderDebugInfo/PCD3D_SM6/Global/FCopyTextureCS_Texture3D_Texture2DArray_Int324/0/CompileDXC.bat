...
%DXC% -HV 2021 /auto-binding-space 0 /Zpr /O3 -Wno-parentheses-equality /T cs_6_6 /E CopyTextureCS /Fc CopyTextureShaders.d3dasm /Fo CopyTextureShaders.dxil CopyTextureShaders.usf
:END
PAUSE
