...
%DXC% -HV 2021 /auto-binding-space 0 /Zpr /O3 -Wno-parentheses-equality /T cs_6_6 /E ClearCountsIntCS /Fc NiagaraClearCounts.d3dasm /Fo NiagaraClearCounts.dxil NiagaraClearCounts.usf
:END
PAUSE
