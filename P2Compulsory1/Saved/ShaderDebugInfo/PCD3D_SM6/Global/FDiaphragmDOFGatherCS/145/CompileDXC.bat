...
%DXC% -HV 2021 /auto-binding-space 0 /Zpr /O3 -Wno-parentheses-equality /T cs_6_6 /E GatherMainCS /Fc DOFGatherPass.d3dasm /Fo DOFGatherPass.dxil DOFGatherPass.usf
:END
PAUSE
