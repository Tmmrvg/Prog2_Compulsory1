...
%DXC% -HV 2021 /auto-binding-space 0 /Zpr /O3 -Wno-parentheses-equality /T vs_6_6 /E VertexMain /Fc ParticleInjectionShader.d3dasm /Fo ParticleInjectionShader.dxil ParticleInjectionShader.usf
:END
PAUSE
