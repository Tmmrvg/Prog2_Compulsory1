...
%DXC% -HV 2021 /auto-binding-space 0 /Zpr /O3 -Wno-parentheses-equality /T cs_6_6 /E ResetPhysicsFieldClipmapCS /Fc PhysicsFieldReset.d3dasm /Fo PhysicsFieldReset.dxil PhysicsFieldReset.usf
:END
PAUSE
