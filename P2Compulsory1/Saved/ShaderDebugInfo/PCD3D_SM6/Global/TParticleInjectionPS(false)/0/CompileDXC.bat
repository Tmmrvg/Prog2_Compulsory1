...
%DXC% -HV 2021 /auto-binding-space 0 /Zpr /O3 -Wno-parentheses-equality /T ps_6_6 /E PixelMain /Fc ParticleInjectionShader.d3dasm /Fo ParticleInjectionShader.dxil ParticleInjectionShader.usf
:END
PAUSE
