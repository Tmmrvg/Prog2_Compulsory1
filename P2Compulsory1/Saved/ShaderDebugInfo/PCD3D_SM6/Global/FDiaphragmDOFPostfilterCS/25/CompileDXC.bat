...
%DXC% -HV 2021 /auto-binding-space 0 /Zpr /O3 -Wno-parentheses-equality /T cs_6_6 /E PostfilterMainCS /Fc DOFPostfiltering.d3dasm /Fo DOFPostfiltering.dxil DOFPostfiltering.usf
:END
PAUSE
