...
%DXC% -HV 2021 /auto-binding-space 0 /Zpr /O3 -Wno-parentheses-equality /T cs_6_6 /E DownsampleCS /Fc DOFDownsample.d3dasm /Fo DOFDownsample.dxil DOFDownsample.usf
:END
PAUSE
