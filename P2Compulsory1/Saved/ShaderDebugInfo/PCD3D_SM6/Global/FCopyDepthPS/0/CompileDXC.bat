...
%DXC% -HV 2021 /auto-binding-space 0 /Zpr /O3 -Wno-parentheses-equality /T ps_6_6 /E CopyDepthPS /Fc CopyDepthTexture.d3dasm /Fo CopyDepthTexture.dxil CopyDepthTexture.usf
:END
PAUSE
