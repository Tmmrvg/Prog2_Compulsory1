...
%DXC% /auto-binding-space 0 /Zpr /O3 -Wno-parentheses-equality /T vs_6_6 /E Main /Fc LightFunctionVertexShader.d3dasm /Fo LightFunctionVertexShader.dxil LightFunctionVertexShader.usf
:END
PAUSE
