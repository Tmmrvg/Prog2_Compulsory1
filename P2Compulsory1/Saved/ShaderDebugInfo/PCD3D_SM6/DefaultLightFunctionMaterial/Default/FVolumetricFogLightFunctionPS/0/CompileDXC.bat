...
%DXC% /auto-binding-space 0 /Zpr /O3 -Wno-parentheses-equality /T ps_6_6 /E Main /Fc VolumetricFogLightFunction.d3dasm /Fo VolumetricFogLightFunction.dxil VolumetricFogLightFunction.usf
:END
PAUSE
