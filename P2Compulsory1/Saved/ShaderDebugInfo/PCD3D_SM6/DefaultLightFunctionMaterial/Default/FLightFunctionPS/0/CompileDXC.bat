...
%DXC% /auto-binding-space 0 /Zpr /O3 -Wno-parentheses-equality /T ps_6_6 /E Main /Fc LightFunctionPixelShader.d3dasm /Fo LightFunctionPixelShader.dxil LightFunctionPixelShader.usf
:END
PAUSE
